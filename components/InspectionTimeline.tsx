  ...
  return (
    <div className="relative pl-8 space-y-8 my-8">
      ...
      {inspections.map((inspection, index) => {
        ...
        return (
          <div key={inspection.id} className="relative animate-in slide-in-from-bottom-4 duration-500" style={{ animationDelay: `${index * 100}ms` }}>
             {/* Connector Dot */}
             ...
             <div className={`
                ...
                border shadow-sm rounded-xl p-5 overflow-hidden transition-all hover:shadow-md
                ${isAggressive
