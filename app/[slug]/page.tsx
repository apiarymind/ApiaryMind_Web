...
import PricingTable from "../../components/PricingTable"; // RESTORED IMPORT
  ...
  if (params.slug === 'landing') {
    page = {
      ...
      sections: [
        ...
        { id: 'pricing', type: 'PRICING', content: 'Cennik' } // RESTORED SECTION CONFIG
      ]
    };
