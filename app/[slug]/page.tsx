...
export default async function DynamicPage({ params }: { params: { slug: string } }) {
  ...
  return (
    // FIX 1: bg-transparent allows the global Layout background (Smoke/Cream) to show through
    <div className="min-h-screen bg-transparent selection:bg-amber-500 selection:text-black">
      ...
      {page.sections?.map((section: any) => {
         switch(section.type) {
            case 'HERO':
               return (
                 <div key={section.id} className="relative pt-32 pb-20 sm:pt-40 sm:pb-24 overflow-hidden flex justify-center px-4">
                    ...
                    {/* FIX 2: ADAPTIVE GLASS TILE (Light: White/Choco | Dark: Black/White) */}
            ...
            case 'FEATURES':
               return (
                 // Glassmorphism for features - Adaptive
